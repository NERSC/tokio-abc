...
#SBATCH -C haswell
#SBATCH -A m888
#DW jobdw type=scratch access_mode=private(client_cache=no) capacity=24TiB pool=sm_pool
...
export TOKIO_PARAMS_FILE="${REPO_BASE_DIR}/inputs/cori-haswell-bb-private.params"
