...
function run_edison() {
REPO_BASE="/global/u2/g/glock/src/git/tokio-paper-edison"
...
srun -n 1536 -N 96 ${REPO_BASE}/ior/install/bin/ior -s 4096 -H -o /scratch1/scratchdirs/$USER/striped/ior.out -f ${REPO_BASE}/inputs/mpiio1m2.in
srun -n 1536 -N 96 ${REPO_BASE}/ior/install/bin/ior -s 4096 -H -o /scratch2/scratchdirs/$USER/striped/ior.out -f ${REPO_BASE}/inputs/mpiio1m2.in
srun -n 1536 -N 96 ${REPO_BASE}/ior/install/bin/ior -s 4096 -H -o /scratch3/scratchdirs/$USER/striped/ior.out -f ${REPO_BASE}/inputs/mpiio1m2.in
srun -n 1536 -N 96 ${REPO_BASE}/ior/install/bin/ior -s 4096 -H -o /scratch1/scratchdirs/$USER/nostriped/ior.out -f ${REPO_BASE}/inputs/posix1m2.in
srun -n 1536 -N 96 ${REPO_BASE}/ior/install/bin/ior -s 4096 -H -o /scratch2/scratchdirs/$USER/nostriped/ior.out -f ${REPO_BASE}/inputs/posix1m2.in
srun -n 1536 -N 96 ${REPO_BASE}/ior/install/bin/ior -s 4096 -H -o /scratch3/scratchdirs/$USER/nostriped/ior.out -f ${REPO_BASE}/inputs/posix1m2.in
...
srun -n 1536 -N 96 ${REPO_BASE}/hacc-io/install/hacc_io_write 20971520 /scratch1/scratchdirs/$USER/nostriped/haccio.out
srun -n 1536 -N 96 ${REPO_BASE}/hacc-io/install/hacc_io_write 20971520 /scratch2/scratchdirs/$USER/nostriped/haccio.out
srun -n 1536 -N 96 ${REPO_BASE}/hacc-io/install/hacc_io_write 20971520 /scratch3/scratchdirs/$USER/nostriped/haccio.out
srun -n 1536 -N 96 ${REPO_BASE}/hacc-io/install/hacc_io_read 20971520 /scratch1/scratchdirs/$USER/nostriped/haccio.out
srun -n 1536 -N 96 ${REPO_BASE}/hacc-io/install/hacc_io_read 20971520 /scratch2/scratchdirs/$USER/nostriped/haccio.out
srun -n 1536 -N 96 ${REPO_BASE}/hacc-io/install/hacc_io_read 20971520 /scratch3/scratchdirs/$USER/nostriped/haccio.out
rm -rf /scratch1/scratchdirs/$USER/nostriped/haccio.out*
rm -rf /scratch2/scratchdirs/$USER/nostriped/haccio.out*
rm -rf /scratch3/scratchdirs/$USER/nostriped/haccio.out*
rm -rf /scratch1/scratchdirs/$USER/nostriped/haccio.out*
rm -rf /scratch2/scratchdirs/$USER/nostriped/haccio.out*
rm -rf /scratch3/scratchdirs/$USER/nostriped/haccio.out*
...
srun -n 1536 -N 96 ${REPO_BASE}/dbcats-io/install/dbscan_read -d '/Step#0/x' -d '/Step#0/y' -d '/Step#0/z' -d '/Step#0/px' -d '/Step#0/py' -d '/Step#0/pz' -f /scratch1/scratchdirs/$USER/striped/vpicio.hdf5
srun -n 1536 -N 96 ${REPO_BASE}/dbcats-io/install/dbscan_read -d '/Step#0/x' -d '/Step#0/y' -d '/Step#0/z' -d '/Step#0/px' -d '/Step#0/py' -d '/Step#0/pz' -f /scratch2/scratchdirs/$USER/striped/vpicio.hdf5
srun -n 1536 -N 96 ${REPO_BASE}/dbcats-io/install/dbscan_read -d '/Step#0/x' -d '/Step#0/y' -d '/Step#0/z' -d '/Step#0/px' -d '/Step#0/py' -d '/Step#0/pz' -f /scratch3/scratchdirs/$USER/striped/vpicio.hdf5
