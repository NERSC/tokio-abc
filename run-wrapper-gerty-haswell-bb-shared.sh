...
#
#SBATCH -J tokio-abc-gerty-haswell-bb
#SBATCH -N 48
#SBATCH -t 01:00:00
#SBATCH -p regular
#SBATCH -C haswell
#DW jobdw type=scratch access_mode=striped capacity=9TiB pool=wlm_pool
...
export TOKIO_PARAMS_FILE="${REPO_BASE_DIR}/inputs/${NERSC_HOST}-haswell-bb-shared.params"
