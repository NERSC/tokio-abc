...
#
#SBATCH -J tokio-abc-cori-knl-bb
#SBATCH -N 256
#SBATCH -p debug
#SBATCH -t 00:30:00
#SBATCH -C knl
#SBATCH -A m888
#DW jobdw type=scratch access_mode=private(client_cache=no) capacity=40TiB pool=sm_pool
...
export TOKIO_PARAMS_FILE="${REPO_BASE_DIR}/inputs/cori-knl-bb-private.params"
